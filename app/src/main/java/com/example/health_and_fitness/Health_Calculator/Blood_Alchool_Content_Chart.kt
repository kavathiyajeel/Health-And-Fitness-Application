...
class Blood_Alchool_Content_Chart : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_blood_alchool_content_chart)
        ...
        supportActionBar?.title = "Blood Alchool Chart"
    }
